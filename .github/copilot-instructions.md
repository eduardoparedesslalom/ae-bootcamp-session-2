...
- [UI Guidelines](../docs/ui-guidelines.md) - UI guidelines and design standards for the app
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles and conventions for the app
